...
Register-ArgumentCompleter -Native -CommandName 'rez' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'rez' {
            [CompletionResult]::new("-h", "-h", [CompletionResultType]::ParameterName, "Show this help message and exit")
            [CompletionResult]::new("--help", "--help", [CompletionResultType]::ParameterName, "Show this help message and exit")
            [CompletionResult]::new("-i", "-i", [CompletionResultType]::ParameterName, "Print information about rez and exit")
            [CompletionResult]::new("--info", "--info", [CompletionResultType]::ParameterName, "Print information about rez and exit")
            ...
            [CompletionResult]::new("-v", "-v", [CompletionResultType]::ParameterName, "Verbose mode, repeat for more verbosity")
            [CompletionResult]::new("--verbose", "--verbose", [CompletionResultType]::ParameterName, "Verbose mode, repeat for more verbosity")
        }
    })

    $completions_old = @(switch ($command) {
        'uv' {
